...
//    if ((SR1_tmp & I2C_SR1_BTF) && (_packet.index < _packet.length - 1)) {
...
// }
    ...
    //         // _i2c->CR2 &= ~(I2C_CR2_ITBUFEN | I2C_CR2_ITERREN | I2C_CR2_ITEVTEN);
    ...
    //  if ((_packet.index >= _packet.length) && !(_i2c->SR2 & I2C_SR2_BUSY)) {
